...
public class BookServiceTest {
    ...
    public void testFindByAuthor() {
        ...
        bookList.add(new Book("1001", "Elasticsearch Basics", "Sandhya", "23-FEB-2017"));
        bookList.add(new Book("1002", "Apache Lucene Basics", "Sandhya", "13-MAR-2017"));
        bookList.add(new Book("1003", "Apache Solr Basics", "Sandhya", "21-MAR-2017"));
        bookList.add(new Book("1007", "Spring Data + ElasticSearch", "Sandhya", "01-APR-2017"));
        bookList.add(new Book("1008", "Spring Boot + MongoDB", "Sandhya", "25-FEB-2017"));

        for (Book book : bookList) {
            bookService.save(book);
        }

        Page<Book> byAuthor = bookService.findByAuthor("Sandhya", new PageRequest(0, 10));
